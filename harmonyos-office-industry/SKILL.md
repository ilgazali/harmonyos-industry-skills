---
name: harmonyos-office-industry
description: Use when building a HarmonyOS office or productivity app - attendance check-in, document approval and preview, secure PDF handling, electronic seals, mail attachments, visitor management, or meeting scheduling.
---

# HarmonyOS Office Industry

Huawei HQ's verified feature catalog for this vertical: 32 features drawn
from `05_office`, backed by 186 evidence-based findings against HQ's own
published documentation. Feature IDs are prefixed `OFFICE-`.
...
Everything below is what is specific to office applications.
...
5. Check the card's **Pitfalls** and
   ...
   31 of 32 cards here correct at least one defect in HQ's
...
| [references/pitfalls.md](references/pitfalls.md) | the 186 findings, systemic ones first |
| `features/OFFICE-*.md` | one card per feature: checklist, architecture, verified code, pitfalls |
...
- Secure document preview and electronic sealing are the two highest-risk features; read their pitfalls in full.
- File open, download and hand-off to another app are three distinct cards with different permission profiles.
- Meeting publication writes into the system calendar; the dialog and the calendar write are separate steps.
